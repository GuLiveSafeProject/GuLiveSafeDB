...
if($action=='shuttle'){
	...
	$shuttle_insert="insert into shuttle_services (email_id,current_location,destination_location,shuttle_message) values('$email_id','$location','$dest_location','$message')";
...
//Insert Knight Services
	...
	$knight_insert="insert into guknights_service (email_id,current_location,destination_location,guknights_message) values('$email_id','$current_location','$destination_location','$guknights_message')";
	$knight=mysql_query($knight_insert);
	if($knight){
    //header("Location:knight_service.php?ss");
		$out=array('status'=>'success');
$result= json_encode($out);
echo $result;
     }
      else{
	//header("Location:knight_service.php?ff");
      	$out=array('status'=>'fail');
$result= json_encode($out);
echo $result;
	}
